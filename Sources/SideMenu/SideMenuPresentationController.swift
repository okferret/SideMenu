...
final class SideMenuPresentationController {
    ...
    internal required init(config: PresentationModel, leftSide: Bool, presentedViewController: UIViewController, presentingViewController: UIViewController, containerView: UIView) {
        self.config = config
    ...
    deinit {
        ...
        // Hop to the main actor synchronously since UI mutation must occur there.
    ...
    internal func containerViewWillLayoutSubviews() {
    ...
    internal func presentationTransitionWillBegin() {
        guard let containerView = containerView,
              let presentedViewController = presentedViewController,
              let presentingViewController = presentingViewController
        else { return }
    ...
    internal func presentationTransition() {
    ...
    internal func presentationTransitionDidEnd(_ completed: Bool) {
    ...
    internal func dismissalTransitionWillBegin() {
        snapshotView?.removeFromSuperview()
    ...
    internal func dismissalTransition() {
        guard let presentedViewController = presentedViewController,
              let presentingViewController = presentingViewController
        else { return }
    ...
    internal func dismissalTransitionDidEnd(_ completed: Bool) {
        guard completed else {
...
extension SideMenuPresentationController {
    ...
    private func transition(to: UIViewController, from: UIViewController, alpha: CGFloat, statusBarAlpha: CGFloat, scale: CGFloat, translate: CGFloat) {
        containerViewWillLayoutSubviews()
    ...
    private func removeStyles(from view: UIView) {
        view.motionEffects.removeAll()
